...
/**
 * @typedef {Object} HyperDHTLookupOpts
 * @property {HyperDHT} dht
 * @property {KeyPair} keyPair
 * @property {number} [cachelTTL]
 * @property {number} [cacheLength]
 * @property {number} [announceTTL]
 * @property {LookupCrypto} [crypto]
 * @property {Buffer} [capability]
 */

class HyperDHTLookup {
  /**
   * @param {HyperDHTLookupOpts} opts
   */
  constructor (opts) {
    this._dht = opts.dht
